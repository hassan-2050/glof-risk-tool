...
| | before | after |
|---|---|---|
| lakes within 25% of published | - | 2/8 |
...
**Result.** Corridors for 12/14 lakes, including both cases the criterion names. Five separate corrections were needed, each forced by a measured failure that produced a one-cell corridor.
...
**Evidence.** Thame is a growth-only FALSE NEGATIVE and a proxy-augmented TRUE POSITIVE. Threshold-free: Thame ranks 1 of 13 on the continuous score. Spearman vs Rounce 2017: 0.6299. outputs/stage07_confusion_matrix.csv; DECISIONS D9
